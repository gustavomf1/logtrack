...
import { LayoutDashboard, ArrowUpRight, CircleHelp, LogOut, LogIn, Radio, Menu, X, Map as MapIcon } from "lucide-react";
import { useState } from "react";
import { Brand } from "./brand";
const navigation = [{ href: "/", label: "Visão geral", icon: LayoutDashboard }, { href: "/mapa", label: "Mapa", icon: MapIcon }];
